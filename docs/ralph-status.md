...
runs:
  ...
  - run_id: "copilot-skills-agent-communication-20260925-0627"
    ...
    next_action: "Coordinator: dispatch worker-01 and worker-02; run the known-answer session-message benchmark and integrate their disjoint changes."
    split_plan:
