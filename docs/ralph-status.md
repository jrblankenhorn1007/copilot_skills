  ...
  - run_id: "copilot-skills-agent-communication-20260925-0627"
    ...
    worker_assignments:
      - worker_id: "worker-01"
        ...
        implementation_commit_sha: "090fa93deb90b31f9bf4ff9ca6ff1d15d2871a32"
      ...
      - worker_id: "worker-02"
        ...
        status: AWAITING_MERGE
        base_parent_sha: "0294550c92a5d79e1cca682a0c509b5bb6eca3fd"
        implementation_commit_sha: "b99ee3b5c1cfd39491de0e5cf14f32276cd547d6"
    ...
    worker_count_note: "The parent is rebased onto origin/main 76afaf32...; the current worker implementation commits are 090fa93d... (worker-01) and b99ee3b5... (worker-02). Prior attestations and merge heads are superseded. Worker-01 has a test-first message-limit fallback refinement; worker-02 remains paused until worker-01 is integrated. Both leaves remain AWAITING_MERGE."
    memory_review:
      status: PENDING
      owner: coordinator
      outcome: null
