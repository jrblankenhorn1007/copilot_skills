...
runs:
  ...
  - run_id: "copilot-skills-agent-communication-20260925-0627"
    ...
    next_action: "Coordinator: commit these records, rebase the parent onto origin/main 1304409b..., then refresh worker targets and rebase worker-01's clean child before READY_TO_EDIT."
    split_plan:
    ...
    worker_assignments:
      - worker_id: "worker-01"
        ...
        implementation_commit_sha: "258f1d50a1a03e0cfbdff6891022c919b753b4ba"
      ...
      - worker_id: "worker-02"
        ...
        status: AWAITING_MERGE
        base_parent_sha: "0294550c92a5d79e1cca682a0c509b5bb6eca3fd"
        implementation_commit_sha: "f13cd5888089195d08d3d9934af5f643b5ac5061"
    ...
    worker_count_note: "The parent is rebased onto bfa49610... and includes worker-01's verified sign-in ledger commit; origin/main has since advanced to 1304409b... through five unrelated agent-sync status-only commits. Current worker implementation commits are 258f1d50... (worker-01) and f13cd588... (worker-02). Prior implementation attestations and merge heads are superseded. Worker-01's clean signed-in child is waiting for the updated parent and READY_TO_EDIT; worker-02 remains paused. Both leaves remain AWAITING_MERGE."
    memory_review:
      status: PENDING
      owner: coordinator
      outcome: null
...
branch_agent_index:
  ...
  - run_id: "copilot-skills-agent-communication-20260925-0627"
    ...
    next_action: "Coordinator: rebase the parent onto current origin/main 1304409b..., refresh this run's status, then rebase worker-01's signed-in child and authorize READY_TO_EDIT."
  - run_id: "copilot-skills-agent-communication-20260925-0627"
