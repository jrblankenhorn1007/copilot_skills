...
- The parent must be rebased from `b9b1496f3fe727d84d07a8413e6288322322e476` onto current fetched `origin/main` `1aceb82683e4db1a6c73a43f91700d574aa150ee`; rerun acceptance checks and re-verify the worker-01 integration afterward.
- Worker-02's two prior replay attempts remain preserved with conflicts; replay its assigned changes on a fresh child from the refreshed parent and obtain fresh verification/sign-off.
