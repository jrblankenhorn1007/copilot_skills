...
checks:
  ...
  - command: "git diff --check"
    result: PASS
blockers: []
next_action: "Coordinator: rebase the parent, rerun final checks, complete parent-to-main integration, and finish the post-merge memory review before marking this worker complete."
worker_sign_off:
  status: RECEIVED
