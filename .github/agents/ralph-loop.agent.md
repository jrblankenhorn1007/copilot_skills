---
name: Ralph Loop
description: Runs one focused Ralph Loop iteration in a fresh Git worktree and branch, applies TDD to behavior changes, verifies its merge to remote main, and captures durable lessons.
